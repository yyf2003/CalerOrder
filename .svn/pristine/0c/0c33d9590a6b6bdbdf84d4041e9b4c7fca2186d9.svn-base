<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImportBasicMaterial.aspx.cs" Inherits="WebApp.Materials.ImportBasicMaterial" %>
...
<body>
    ...
    <div style=" height:130px;">
       <div id="ImportState" runat="server" style="height: 130px; margin-top:10px;text-align:left; display:none;">

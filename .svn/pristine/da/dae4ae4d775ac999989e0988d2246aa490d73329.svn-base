<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WebApp.Subjects.SupplementByRegion.List" %>
    ...
    <div>
        <asp:GridView ID="gv" runat="server" AutoGenerateColumns="false" CellPadding="0"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="subject.SubjectName" HeaderText="补单名称" HeaderStyle-BorderColor="#dce0e9" />

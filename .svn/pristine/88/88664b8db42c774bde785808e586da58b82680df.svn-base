<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WebApp.Subjects.SecondInstallFee.List" %>
    ...
    <div>
        <asp:GridView ID="gv" runat="server" AutoGenerateColumns="false" CellPadding="0"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="SecondInstallPrice" HeaderText="安装费金额" HeaderStyle-BorderColor="#dce0e9" />

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmptyDateWarn.aspx.cs" Inherits="WebApp.Subjects.EmptyDateWarn" %>
...
<body>
   ...
   <div>
       ...
       <div style=" margin:10px;">
        提示：缺失的信息包括：区域、省份、城市、城市级别、是否安装、店铺地址、店铺规模大小、店铺级别(物料支持级别)
       </div>
    </div>
    </form>
</body>

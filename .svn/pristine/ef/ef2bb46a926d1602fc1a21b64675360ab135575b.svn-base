<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InstallConfirm.aspx.cs" Inherits="WebApp.Subjects.InstallManagement.InstallConfirm" %>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#upload1").uploadify({
                ...
                'uploader': '/uploadify/Handler1.ashx?subjectid=' + subjectId + "&secitemid=" + secItemId + "&filecode=" + fileCode + "&filetype=" + fileType,
                'fileSizeLimit': '50MB',
                'buttonText':'选择图片',
...
<body>
    ...
    <div class="tr" style="margin-top: 10px;">
     ...
     <table class="table">
        <tr class="tr_bai">
           ...
           <td style=" text-align:left; padding-left:5px;">
               <asp:TextBox ID="txtInstallDate" runat="server" onclick="WdatePicker()"></asp:TextBox>
        ...
        <tr class="tr_bai">
           ...
           <td style=" text-align:left; padding-left:5px;">
               <asp:TextBox ID="txtFinishDate" runat="server" onclick="WdatePicker()"></asp:TextBox>
               <span style="color:Red;">*</span>
           </td>
        </tr>
        <tr class="tr_bai">
           ...
           <td style=" text-align:left; padding-left:5px;">
               <asp:TextBox ID="txtInstallUserName" runat="server"></asp:TextBox>
        ...
        <tr class="tr_bai">
           ...
           <td style=" text-align:left; padding-left:5px;">
               <asp:Label ID="labDefaultInstallPrice" runat="server" Text=""></asp:Label>
           </td>
           </tr>
           <tr class="tr_bai">
           <td style=" width:100px;">
           ...
           <td style=" text-align:left; padding-left:5px;">
               <asp:TextBox ID="txtOtherPriceRemark" runat="server" style=" width:300px;"></asp:TextBox>
        ...
        <tr class="tr_bai">
           ...
           <td style=" text-align:left; padding-left:5px; padding-top:5px;">
              ...
              <div id="showfiles" style=" margin-bottom:5px;"></div>
           </td>
        </tr>
        <tr class="tr_bai">
           <td>
    ...
    <asp:HiddenField ID="hfInstallId" runat="server" />

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApproveList.aspx.cs" Inherits="WebApp.Subjects.RegionSubject.ApproveList" %>
        ...
        <asp:GridView ID="gv" runat="server" AutoGenerateColumns="false" CellPadding="0"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="项目类型" HeaderStyle-BorderColor="#dce0e9">
                    <ItemTemplate>
                        <asp:Label ID="labSubjectType" runat="server"></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NotFinishList.aspx.cs" Inherits="WebApp.Subjects.RegionSubject.NotFinishList" %>
    ...
    <div>
        <asp:GridView ID="gv" runat="server" AutoGenerateColumns="false" CellPadding="0"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="RegionSubmitUser" HeaderText="分区提交人" HeaderStyle-BorderColor="#dce0e9" />
                ...
                <asp:TemplateField HeaderText="编辑" HeaderStyle-BorderColor="#dce0e9">
                    <ItemTemplate>
                        <asp:LinkButton CommandArgument='<%#Eval("Id") %>' ID="lbEdit" CommandName="EditItem" runat="server" Style="color: Blue;">编辑订单</asp:LinkButton>
                    </ItemTemplate>
                    <HeaderStyle Width="60px"></HeaderStyle>
                </asp:TemplateField>

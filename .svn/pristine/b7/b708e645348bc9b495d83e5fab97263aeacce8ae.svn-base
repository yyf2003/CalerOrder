<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApproveList.aspx.cs" Inherits="WebApp.Subjects.SupplementByRegion.ApproveList" %>
    ...
    <div>
        <asp:GridView ID="gv" runat="server" AutoGenerateColumns="false" CellPadding="0"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="项目类型" HeaderStyle-BorderColor="#dce0e9">
                    <ItemTemplate>
                        <asp:Label ID="labSubjectType" runat="server" Text="分区订单"></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:BoundField DataField="SupplementRegion" HeaderText="区域" HeaderStyle-BorderColor="#dce0e9" />
                ...
                <asp:TemplateField HeaderText="查看" Visible="false" HeaderStyle-BorderColor="#dce0e9">
                    <ItemTemplate>
                        <asp:LinkButton ID="lbCheck" runat="server" CommandName="Check" CommandArgument='<%#Eval("Id") %>'>查看</asp:LinkButton>
                    </ItemTemplate>
                    <HeaderStyle Width="50px"></HeaderStyle>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="审批" Visible="false" HeaderStyle-BorderColor="#dce0e9">
                    <ItemTemplate>
                        <asp:LinkButton ID="lbApprove" runat="server" CommandName="Approve" CommandArgument='<%#Eval("Id") %>'>审批</asp:LinkButton>
                    </ItemTemplate>
                    <HeaderStyle Width="50px"></HeaderStyle>
                </asp:TemplateField>
            </Columns>

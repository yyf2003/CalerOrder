<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CheckDetail.aspx.cs" Inherits="WebApp.Subjects.Received.CheckDetail" %>
...
<script type="text/javascript">
    $(function () {
        ...
        GetFiles(subjectId, secItemId, fileCode, fileType, $("#ReceiveFiles"));

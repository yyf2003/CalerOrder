<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UploadFiles.aspx.cs" Inherits="WebApp.Quotation.UploadFiles" %>

<%@ Register src="../FileUploadUC/UpLoadUC.ascx" tagname="UpLoadUC" tagprefix="uc1" %>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#upload1").uploadify({
                ...
                'uploader': '../uploadify/Handler1.ashx?subjectid=' + subjectId + "&filecode=" + fileCode + "&filetype=" + fileType,
                'fileSizeLimit': '50MB',
            ...
            function GetFiles() {
                $.ajax({
                    type: 'get',
                    url: '../Handler/Files.ashx?type=getfiles&subjectid=' + subjectId + "&filecode=" + fileCode + "&filetype=" + fileType,
                    cache: false,
    ...
    <table class="table">
       <tr>
          <td style=" height:500px; vertical-align:top;">
             <%-- 
              <uc1:UpLoadUC ID="UpLoadUC1" runat="server" Code="1"/>

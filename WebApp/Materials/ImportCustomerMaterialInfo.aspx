<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImportCustomerMaterialInfo.aspx.cs" Inherits="WebApp.Materials.ImportCustomerMaterialInfo" %>
        ...
        <tr class="tr_bai">
            ...
            <td style="text-align: left; padding-left: 5px;">
                <asp:LinkButton ID="lbDownLoadShop" runat="server" 
                    onclick="lbDownLoadShop_Click">下载模板</asp:LinkButton>

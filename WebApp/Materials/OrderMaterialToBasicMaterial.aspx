<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderMaterialToBasicMaterial.aspx.cs"
    Inherits="WebApp.Materials.OrderMaterialToBasicMaterial" %>
...
<body class="easyui-layout">
    ...
    <div data-options="region:'west',split:true,title:'材质类型'" style="width: 200px;">
    ...
    <div data-options="region:'center',title:'',height:'100%',iconCls:'icon-ok'" style="overflow: hidden;">
        <div id="materialTitle" class="easyui-panel" title=">>材质类型：" data-options="height:'100%',overflow:'auto'">
            ...
            <div id="toolbar" style="height: 60px">
                ...
                <div>
                    ...
                    <a id="btnExport" style="float: left;" class="easyui-linkbutton" plain="true" icon="icon-undo">
                        导出</a> <a id="btnImport" style="float: left;" class="easyui-linkbutton" plain="true"
                            icon="icon-back">导入</a>
                    <div class='datagrid-btn-separator'>
                    </div>

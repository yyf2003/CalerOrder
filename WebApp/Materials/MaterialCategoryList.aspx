<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MaterialCategoryList.aspx.cs" Inherits="WebApp.Materials.MaterialCategoryList" %>
...
<body>
   ...
   <div class="nav_title">
    ...
    <asp:GridView ID="gv" runat="server" AutoGenerateColumns="false" CellPadding="0"
        ...
        >
            ...
            <asp:TemplateField HeaderText="编辑" Visible="false" HeaderStyle-BorderColor="#dce0e9" HeaderStyle-Width="60px">
               <ItemTemplate>
                  <span data-categoryid='<%#Eval("Id") %>' onclick="editCategory(this)" style="color:blue; cursor:pointer;">编辑</span>
               </ItemTemplate>
            </asp:TemplateField>
    ...
    <div id="editCategoryDiv" title="添加类型" style="display:none;">
        <table style="width:350px;text-align:center;">
            <tr>
                <td style="width:120px;height:30px;">类型名称</td>
                <td style="text-align:left;padding-left:5px;">
...
<script src="js/MaterialCategoryList.js" type="text/javascript"></script>

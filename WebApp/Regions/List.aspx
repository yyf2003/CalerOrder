<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WebApp.Regions.List" %>
...
<body>
        ...
        <table class="table">
            <tr class="tr_bai">
                ...
                <td style="text-align: left; padding-left: 5px;">
                    <asp:TextBox ID="txtRegionNameSearch" runat="server" MaxLength="10"></asp:TextBox>
                </td>
            </tr>
    ...
    <div>
        ...
        HeaderStyle-BorderStyle="None" EmptyDataText="--无符合条件的信息--" 
           ...
           <Columns>
            ...
            <asp:BoundField DataField="RegionName" HeaderText="区域名称" HeaderStyle-BorderColor="#dce0e9"/>
            <asp:TemplateField HeaderText="省份"   HeaderStyle-BorderColor="#dce0e9">
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="编辑" Visible="false"  HeaderStyle-BorderColor="#dce0e9">
                <ItemTemplate>
                   ...
                   <asp:HiddenField ID="hfProvinceIds" runat="server"/>
                   <span data-regionid='<%#Eval("Id") %>' onclick="editRegion(this)" style="color: blue;
            ...
            <asp:TemplateField HeaderText="操作" Visible="false"  HeaderStyle-BorderColor="#dce0e9">
                <ItemTemplate>
                   <asp:LinkButton ID="lbDelete"  CommandArgument='<%#Eval("Id") %>' runat="server">删除</asp:LinkButton>
                </ItemTemplate>
                <HeaderStyle Width="50px"></HeaderStyle>
            </asp:TemplateField>
           </Columns>
    ...
    <div id="editDiv" title="添加区域" style="display:none;">
        <table style="width:500px;text-align:center;">
           <tr>
            ...
            <tr>
                <td style="width:120px;height:30px;">区域名称</td>
                <td style="text-align:left;padding-left:5px;">
                    <asp:TextBox ID="txtRegionName" runat="server" MaxLength="50"></asp:TextBox>
                    <span style="color:Red;">*</span>
                    
                </td>
            </tr>
           <tr>
                <td style="width:120px;height:100px;">省份(<span style="color:Red;">*</span>)</td>
                <td style="text-align:left;padding-left:5px;">
                   <div id="provinceDiv">
                    <asp:CheckBoxList ID="cblProvince" runat="server" RepeatDirection="Horizontal" 

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ActivityList.aspx.cs" Inherits="WebApp.Customer.ActivityList" %>
...
<body>
    ...
    <div>
        <asp:GridView ID="gv" runat="server" AutoGenerateColumns="false" CellPadding="0"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="ActivityName" HeaderText="类型名称" HeaderStyle-BorderColor="#dce0e9" />
                
                
                <asp:TemplateField HeaderText="编辑" HeaderStyle-Width="80" HeaderStyle-BorderColor="#dce0e9">
                    <ItemTemplate>
                        <span name="edit" data-activityid='<%#Eval("ActivityId") %>' style="color: Blue; cursor: pointer;">
                            编辑</span>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="操作" HeaderStyle-Width="80" HeaderStyle-BorderColor="#dce0e9">
                    <ItemTemplate>
                        <asp:LinkButton ID="lbDelete" CommandArgument='<%#Eval("ActivityId") %>' CommandName="DeleteItem" runat="server">删除</asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
    ...
    <div id="editDiv" title="编辑活动类型信息" style="display: none;">
...
<script src="js/ActivityList.js" type="text/javascript"></script>

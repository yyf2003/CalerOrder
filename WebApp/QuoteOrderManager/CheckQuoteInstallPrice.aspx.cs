    ...
    public partial class CheckQuoteInstallPrice : BasePage
    {
        ...
        protected void gvInstallPrice_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemIndex != -1)
            {
                ...
                if (dataItem != null)
                {
                    object objBasicPrice = dataItem.GetType().GetProperty("BasicPrice").GetValue(dataItem, null);
                    object objWindowPrice = dataItem.GetType().GetProperty("WindowPrice").GetValue(dataItem, null);
                    object objOOHPrice = dataItem.GetType().GetProperty("OOHPrice").GetValue(dataItem, null);

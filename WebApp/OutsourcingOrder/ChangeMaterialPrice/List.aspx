<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WebApp.OutsourcingOrder.ChangeMaterialPrice.List" %>
               ...
               <table class="table">
                ...
                <table class="table" style="margin-top: 20px;">
                  <tr>
                     ...
                     <td style="text-align:left; padding-left:5px;">
                         <asp:Button ID="btnUpdatePrice" runat="server" Text="更 新" 
                             class="layui-btn layui-btn-small" OnClientClick="return checkUpdate()"/>
                         <img src="../../image/WaitImg/loadingA.gif" id="loadUpdatePrice" style=" display:none;"/>
                         <%--<asp:Label ID="labUpdateMsg" runat="server" Text=""></asp:Label>--%>

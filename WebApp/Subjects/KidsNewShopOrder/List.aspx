<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WebApp.Subjects.KidsNewShopOrder.List" %>
    ...
    <div>
        <table class="table">
            ...
            <tr class="tr_bai">
                ...
                <td colspan="3" style="text-align: left; padding-left: 5px;">
                    <asp:CheckBoxList ID="cblSubjectType" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
                    </asp:CheckBoxList>
                </td>
        ...
        <div style="text-align: right; padding-right: 25px; margin-top: 8px;">
            ...
            <asp:Button ID="btnAdd" runat="server" Text="新建项目" class="easyui-linkbutton" Style="width: 80px;
                height: 26px; margin-left: 20px; display:;" OnClick="btnAdd_Click" />
        </div>
    </div>
    <br />
    <div class="tr">

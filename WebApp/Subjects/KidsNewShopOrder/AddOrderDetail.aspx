<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddOrderDetail.aspx.cs"
    Inherits="WebApp.Subjects.KidsNewShopOrder.AddOrderDetail" %>
...
<body>
    ...
    <blockquote class="layui-elem-quote" style="height: 15px; font-weight: bold; padding-top: 8px;
        padding-left: 5px;">
        项目信息</blockquote>
    ...
    <div class="layui-tab layui-tab-brief" lay-filter="order">
        ...
        <div class="layui-tab-content" style="overflow: auto; padding: 5px;">
    ...
    <div id="popDetailDiv" style="display: none; padding-top: 10px; position: relative;
        ...
        <blockquote class="layui-elem-quote">
            ...
            &nbsp; <span id="btnGetPOP" class="layui-btn layui-btn-small"><i class="layui-icon">
                &#xe615;</i>获取POP信息</span> &nbsp; <span id="btnSetProp" class="layui-btn layui-btn-small">
                    <i class="layui-icon">&#xe620;</i>道具设置</span>

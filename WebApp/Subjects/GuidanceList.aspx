           ...
           <Columns>
            ...
            <asp:TemplateField HeaderText="状态"  HeaderStyle-BorderColor="#dce0e9">
                <ItemTemplate>
                    ...
                    <%--<asp:LinkButton ID="lbStatus" runat="server" CommandName="EditState" CommandArgument='<%#Eval("ItemId") %>'   style="color:Red;"></asp:LinkButton>--%>
                </ItemTemplate>
            ...
            <asp:TemplateField HeaderText="编辑" Visible="false"  HeaderStyle-BorderColor="#dce0e9">
                <ItemTemplate>
                    <asp:LinkButton CommandArgument='<%#Eval("ItemId") %>' ID="lbEdit" CommandName="EditOrder" runat="server">编辑</asp:LinkButton>
                    |
                     <span onclick="upload(<%#Eval("ItemId") %>)" style="color:Blue;cursor:pointer;">附件信息</span> 
                    |
                    <span onclick="uploadShopMaterialSupport(<%#Eval("ItemId") %>)" style="color:Blue;cursor:pointer;">物料支持级别</span> 
                </ItemTemplate>
            ...
            <%--<asp:TemplateField HeaderText="安装费" Visible="false"  HeaderStyle-BorderColor="#dce0e9">
             ...
             <asp:TemplateField HeaderText="操作" Visible="false"  HeaderStyle-BorderColor="#dce0e9">
                <ItemTemplate>
                    <asp:LinkButton CommandArgument='<%#Eval("ItemId") %>' CommandName="DeleteItem" ID="lbDelete" runat="server">删除</asp:LinkButton>
                </ItemTemplate>
                <HeaderStyle Width="50px"></HeaderStyle>
            </asp:TemplateField>
...
<script type="text/javascript">
    ...
    function uploadShopMaterialSupport(itemId) {
        var url = "ShopMaterialSupportManage/List.aspx?guidanceId=" + itemId;
        $j.fancybox({
            href: url,
            type: 'iframe',
            padding: 5,

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RejectSubjectList.aspx.cs"
    Inherits="WebApp.Subjects.RejectSubjectList" %>
    ...
    <table class="table">
        ...
        <tr class="tr_bai conditionTr">
            ...
            <td colspan="3" style="text-align: left; padding-left: 5px; width: 250px;">
                ...
                <asp:CheckBoxList ID="cblGuidance" runat="server" RepeatDirection="Horizontal"

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SubjectList.aspx.cs" Inherits="WebApp.Subjects.ADErrorCorrection.SubjectList" %>
    ...
    <div>
        ...
        HeaderStyle-BorderStyle="None" EmptyDataText="--无符合条件的信息--" 
           ...
           <Columns>
            ...
            <asp:BoundField DataField="guidance.AddDate" HeaderText="创建时间" HeaderStyle-BorderColor="#dce0e9"/>
            
            <asp:TemplateField HeaderText="纠错状态"  HeaderStyle-BorderColor="#dce0e9">
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="查看"  HeaderStyle-BorderColor="#dce0e9">
                <ItemTemplate>
                    <asp:LinkButton CommandArgument='<%#Eval("guidance.ItemId") %>' CommandName="Check" ID="lbCheck" runat="server" style="color:Blue;">查看</asp:LinkButton>
                </ItemTemplate>
                <HeaderStyle Width="50px"></HeaderStyle>
            </asp:TemplateField>

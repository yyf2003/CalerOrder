<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImportNewShopOrder.aspx.cs" Inherits="WebApp.Subjects.RegionSubject.ImportNewShopOrder" %>
        ...
        <table style="width: 100%;">
            <tr>
                ...
                <td style="text-align: left; padding-left: 5px; width: 300px;">
                    ...
                    <asp:CheckBox ID="cbKeep" runat="server"  style=" margin-left:30px;"/>保留原数据
                    </div>

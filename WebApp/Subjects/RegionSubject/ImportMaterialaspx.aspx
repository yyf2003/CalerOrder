<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImportMaterialaspx.aspx.cs"
    Inherits="WebApp.Subjects.RegionSubject.ImportMaterialaspx" %>
        ...
        <table style="width: 100%;">
            <tr>
                ...
                <td style="text-align: left; padding-left: 5px; width: 300px;">
                    ...
                    <asp:CheckBox ID="cbAdd" runat="server"  style=" margin-left:30px;"/>追加
                    </div>

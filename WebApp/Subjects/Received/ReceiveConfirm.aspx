<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReceiveConfirm.aspx.cs" Inherits="WebApp.Subjects.Received.ReceiveConfirm" %>
...
<body>
    ...
    <table class="table">
        <tr class="tr_bai">
           ...
           <td style=" text-align:left; padding-left:5px;">
               <asp:Label ID="labSendDate" runat="server" Text=""></asp:Label>
           </td>
        </tr>
        <tr class="tr_bai">
           <td>
           ...
           <td style=" text-align:left; padding-left:5px;">
              <asp:Label ID="labSendNumber" runat="server" Text=""></asp:Label>
           </td>
        </tr>
        <tr class="tr_bai">
           <td>
        ...
        <tr class="tr_bai">
           ...
           <td style=" text-align:left; padding:5px;">
              <asp:Label ID="labSendRemark" runat="server" Text=""></asp:Label>
           </td>
        </tr>
     </table>
    <br />
    <div class="tr" style="margin-top: 10px;">
     ...
     <table class="table">
        <tr class="tr_bai">
           ...
           <td style=" text-align:left; padding-left:5px;">
               <asp:TextBox ID="txtReceiveDate" runat="server" onclick="WdatePicker()"></asp:TextBox>
    ...
    <asp:HiddenField ID="hfReceiveId" runat="server" />
    </form>
</body>
</html>
...
<script type="text/javascript">
    $(function () {
        GetFiles(subjectId, secItemId, sendFileCode, fileType, $("#SendFiles"));

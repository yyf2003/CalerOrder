...
namespace WebApp.Base
{
    public class DelegateClass
    {
        ...
        public delegate void DeleSaveOutsourceOrder(int guidanceId, int subjectId, int subjectType);

        public void SaveOutsourceOrder(int guidanceId, int subjectId, int subjectType)
        {
        ...
        void SaveOutsourceOrderHandler(int guidanceId, int subjectId, int subjectType)
        {
